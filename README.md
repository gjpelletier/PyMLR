...
- optimization of binomial or multinomial response variables with either sklearn LogisticRegression (logistic_auto), XGBoost XGBClassifier (xgb_auto), sklearn SVC (svr_auto), or  sklearn KNeighborsClassifier (knn_auto) using the optional keyword argument classify=True
