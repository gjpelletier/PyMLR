...
- automatic cross-validated optimization of hyperparameters by optuna for XGBoost, CatBoost, GradientBoostingRegressor, RandomForestRegressor, SVR, KNeighborsRegressor, or LogisticRegression (RepeatedKFold for regression of continuous response variables, StratifiedKFold for binomial or multinomial response variables)
- automatic cross-validated LassoCV, LassoLarsCV, RidgeCV, or ElasticNetCV regression
...
# Use the xgb_auto function in the PyMLR module
...
# Use the catboost_auto function in the PyMLR module
...
# Use the svr_auto function in the PyMLR module
...
# Use the lasso function in the PyMLR module
...
# Use the ridge function in the PyMLR module
from PyMLR import ridge
...
# Use the elastic function in the PyMLR module
...
# Use the stacking function in the PyMLR module
...
# Use the stepwise function in the PyMLR module
