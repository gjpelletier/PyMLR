...
PyMLR includes the following functions for optimization of 2-stage hybrid machine learning models either combining two models in sequence or using the same model with Recursive Feature Elimination based on permutation importances of stage 1:
